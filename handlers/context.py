from config import APPLICATIONS_FILE, CONTACTS_FILE, DOCS_DIR, PREMISES_FILE, SPECIAL_OFFERS_FILE, TRADE_PLACES_FILE
...
contact_service = ContactService(CONTACTS_FILE)
